...
\noindent De to kapacitorer blev målt inden implementering samt den samlede kapacitans. Resultaterne fremgår i  \tableref{Tab:Acc_kondensator}:
\begin{table}[H]
	\centering
...
På \figref{pforsoeg1} ses den endelige forsøgsopsætningen.
\begin{figure}[H]
	\centering
