...
På \figref{Fig:Pilot_Rotfrek} ses en FFT af målingerne af rotationerne. Ud fra dette kan der ses, at der er kommet større udsving i de lavere frekvenser fra $0-$ til ca. $25$Hz sammenlignet med de statiske baseline målinger. Signalet regnes altså for at være i frekvensspektrummet $0-25$Hz. Alt uden for dette spektrum regnes derfor som støj. For at undersøge hvor meget støj der er på signalet beregnes spændingens signalværdi for accelerometeret ved at foretage en RMS-analyse, som udregner den kvadratiske middelværdi af kvadraterne, for hhv. højre og venstre rotation. RMS-værdien for højre side er på 0.0141, mens den for venstre side er 0.0118, hvilket vil sige at signalet er 0.0141 gange spændingsværdien for højre og 0.0118 gange spændingsværdien for den venstre side.
