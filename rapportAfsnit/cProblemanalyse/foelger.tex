...
%Jævnfør afsnit \ref{HjerneSenMot} på side \pageref{HjerneSenMot} kan en apopleksiskade sensoriske såvel som motoriske funktioner, som kan ses på \figref{Enc} på side \pageref{Enc} .\\
