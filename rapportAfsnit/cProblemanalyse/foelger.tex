...
De sensoriske skader sker i det primære sensoriske cortex%, hvilket fremgår af \figref{Enc2}
. Symptomerne på de sensoriske følger kan være:
\begin{description}
...
De motoriske skader sker hovedsageligt i det primære motoriske cortex%, hvilket fremgår af \figref{Enc2},
 og har bl.a. følgende symptomer:
\begin{description}
