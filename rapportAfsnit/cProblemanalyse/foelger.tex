...
\begin{figure}[H]
	...
	\label{Enc2}
\end{figure}
\fxnote{dette billede skal laves om, men jeg kan ikke gøre det}

De motoriske skader sker hovedsageligt i det primære motoriske cortex, hvilket fremgår af \figref{Enc2}, og har bl.a. følgende symptomer:
\begin{description}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1.1]{figures/bProblemanalyse/Pusher.png}
