...
\begin{table} [H]
  \begin{tabular}{ | l | p{8cm} |}
    ...
    \textbf{Område i encephalon} & \textbf{Funktioner} \\ \hline
 	...
 	Det visuelle kortex & Fortolker lyssignaler og videresender informationer omkring rumlige forhold, bevægelse og koordinerer visuelle og somatosensoriske impulser. \\ \hline
 	Det præmotoriske kortex & Integrerer den sensoriske og motoriske systemer og igangsætter bevægelse som respons på visuelle eller auditive stimuli. \\ \hline
 	Det præfrontale kortex & Koordinerer information fra de andre kortex og udarbejder abstrakte intellektuelle funktioner, som at forudse hvilken effekt en handling vil have. Bearbejdere eksterne sanseindtryk inden der foretages en handling. \\ \hline
    ...
    \hline
    \end{tabular}
    \caption{Tabel over de områder af enceephalon som påvirker balancen, samt deres funktion. \cite{Martini2012, Moos2010}}
\end{table}
\end{center}
