...
På \figref{Patientsikkerhed} ses den effekt som elektrisk strøm kan have på patienten ved forskellige strømstyrker, stadierne overlappe hinanden og foregå samtidig. Disse effekter kan opdeles i seks forskellige stadier: \cite{Webster2009}
