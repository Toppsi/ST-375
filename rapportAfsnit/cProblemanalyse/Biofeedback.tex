...
Fysiologisk biofeedback omfatter måling på forskellige kropslige systemer. Det kan blandt andet måles på det neuromuskulære system, det kardiovaskulære system samt respirationssystemet.  En fysiologisk feedback kan f.eks. avendes til patienter med balanceproblemer ved brug af elektromyografisk (EMG) feedback, hvor myoelektriske signaler omsættes til et signal til patienten. Foruden EMG, kan der anvendes hjerneaktivitet (EEG), øjenmuskelaktivitet (EOG) og hjerteaktivitet (EKG) til feedback til pateinter med balanceproblemer, da EEG, EOG og EKG alle er dele af kroppens systemer og derved påvirkes ved at kroppen er i ubalance... 



 som alle er en del af kroppens systemer, der kan blive påvirket, hvis kroppen er i ubalance. Hvilken sensor der skal bruges afhænger af, hvilken lidelse patienten har \cite{Prentice2007}. 

 
Hvis balancen hos en patient skulle måles

Herunder hører f.eks. elektromyografisk (EMG) feedback, hvor myoelektriske signaler omsættes til et signal til patienten, hvormed der kan opnås bevidsthed om f.eks. svage muskler. Foruden EMG, kan der næves hjerneaktivitet (EEG), øjenmuskelaktivitet (EOG) og hjerteaktivitet (EKG), som alle er en del af kroppens systemer, der kan blive påvirket, hvis kroppen er i ubalance. Hvilken sensor der skal bruges afhænger af, hvilken lidelse patienten har \cite{Prentice2007}.
...
Herudover findes et smerte algometer, som kan gemme målinger af smerte, en trykplade, som kan måle fordelingen af en persons kropsvægt under forskellige øvelser, gyroskop, som kan måle kropshældning, når sensoren er placeret på patienten, accelerometer, som kan måle accelerationen i en bestemt retning. Valget af hvilke apparater og sensorer der er fordelagtige afhænger af patientens tilstand f.eks. hørelse og følsomhed, samt sværhedsgraden af hjerneskaden og hvilke funktioner, der skal genoptrænes. \cite{Hjaelpemiddelbasen}
