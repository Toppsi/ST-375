...
\begin{align}
\label{TilpasEq1} 0.0753V \cdot 10 = 0.7534V \\
\label{TilpasEq2} \dfrac{3V}{0.7534V} = 3.9819 \approx 3 \\
...
\begin{itemize}
	...
	\item Skal have en forsyningsspænding på  $5.5V$.\fxnote{evt. rette dette til}
