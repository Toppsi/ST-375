...
Den maksimale variation i pasbåndstransmissionen ($A_{max}$) sættes til 3dB. For at sikre at $50$Hz støj fjernes, dæmpes med en faktor $5$\fxnote{ret evt. dette til}. For at udregne dæmpningen i dB $A_{min}$, anvendes følgende formel:
\begin{equation}
...
\begin{itemize}
	...
	\item Der accepteres en afvigelse på $10\%$ ift. dæmpningen af signalet.\fxnote{Skal rettes til, når vi finder ud af, hvilken faktor, vi skal dæmpe med. Kræver at vi ved LSB}
