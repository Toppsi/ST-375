...
\begin{equation}
Vout = Va - V$1$\\
Vout = $1.60$V - $1.5915$V\\
Vout = $0,0085$V = $8.5$mV
\end{equation}  
...
\begin{figure}[H]
\centering
\includegraphics[scale=1]{figures/cProblemsloesning/Offset_simulering.png}
\caption{På figuren ses en simulering af kredsløbet som ses på \figref{fig:Offset_generisk}. 
