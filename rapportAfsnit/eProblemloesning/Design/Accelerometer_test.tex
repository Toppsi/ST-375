...
\end{equation}
For at undgå loading fra andre blokke i systemet benyttes en buffer, jævnfør bilag \ref{Bilag:Pilotforsoeg}, side \pageref{Bilag:Pilotforsoeg}. Til bufferkonfigurationen bruges en operationsforstærker af typen TL$081$, hvis pinkonfiguraion kan ses på \figref{TL081}. 
