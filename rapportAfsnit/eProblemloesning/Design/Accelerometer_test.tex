...
\end{equation}
For at undgå loading fra andre blokken i systmet benyttes en buffer. En buffer er en ikke-inverterende konfiguration med gain $1$, hvilket designes med en operationsforstærker, som har koblet den inverterende terminal med outputterminalen. Til bufferkonfigurationen bruges en operationsforstærker af typen TL$081$, hvis pinkonfiguraion kan ses på \figref{TL081}. 
