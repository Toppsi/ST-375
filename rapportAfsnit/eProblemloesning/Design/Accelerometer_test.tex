...
Accelerometerets båndbredde bestemmes af to $0.1\mu$F kapacitorer i parallelforbindelse, disse blev målt med et multimeter for at måle den reeele kapacitans. Denne ses i \tableref{Tab:Acc_kondensator}. Derudover blev der benyttet en $0.1\mu$F kapacitor til power supply decoupling af accelerometeret, dennes reele værdi ses også i \tabelref{Tab:Acc_kondensator}.
\begin{table}[]
\centering
\caption{My caption}
...
\begin{tabular}{|l|l|l|}
\hline
Teoretisk & Målt        & Afvigelse \\ \hline
$0.2\mu$F & $0.211\mu$F & $5.5 %$  \\ \hline
$0.1\mu$F & $0.1017\mu$F & $1.7 %$ \\ \hline
\end{tabular}
\end{table}
