...
\begin{figure}[H] 
	\centering
	\includegraphics[scale=0.9]{figures/cProblemloesning/eksempel_speadingstrae.PNG}
...
Positiv retning : 0.0037\text{V} \cdot 9.1 \cdot 3.6 \cdot \text{hældningsgrad} = \text{tærskelværdi} \\
Negativ retning : 0.0036\text{V} \cdot 9.1 \cdot 3.6 \cdot \text{hældningsgrad} = \text{tærskelværdi}
\end{eqnarray}
