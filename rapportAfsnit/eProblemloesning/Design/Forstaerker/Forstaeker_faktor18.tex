...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		\hline
		\textit{Teoretisk input} & \textit{Målte input} & \textit{Forventet output} & \textit{Output} & \% \textit{\begin{tabular}[c]{@{}l@{}}Faktiske\\ forstærkning\end{tabular}} & \textit{\begin{tabular}[c]{@{}l@{}}\% afvigelse\\ i forstærkning\end{tabular}} \\ \hline
		$0.2712$V   & $0.2726$V    & $2.7260$V     & $2.7096$V       &    9.94   & $0.06\%$     \\ \hline
%		$0$V        & $0.3523$mV   & $3.5230$mV    & -$10$mV         & $38.49\%$      \\ \hline
		-$0.2660$V  & -$0.2641$V   & -$2.6410$V    & -$2.6388$V      &    9.99   & $0.01\%$     \\ \hline
	\end{tabular}
