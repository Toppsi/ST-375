...
Der ses på \figref{fig:Forstaerker_faktor18}, at der skal benyttes to modstandere på $10$K$\Omega$ og $90$K$\Omega$ til opbygningen af forstærkeren. Reelt findes der ikke en $90$K$\Omega$, hvorfor der istedet benyttes en $22$K$\Omega$ og $68$K$\Omega$ modstander i serie forbindelse, hvilket teoretisk vil give en $0$\% afvigelse fra en ideel $90$K$\Omega$ modstand. Disse tre modstande blev målt inden testen, hvilket fremgår i \tableref{Tab:modstand_faktor18}.
\begin{table}[H]
	\centering
	\begin{tabular}{|l|l|l|}
		\hline
