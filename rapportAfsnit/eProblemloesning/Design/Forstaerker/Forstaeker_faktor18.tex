...
\end{table}
\noindent Herefter blev kredsløbet implementeret. Til afbildning af signalet blev der benyttet et multimeter, som målte det forstærkede signal for de to spændingsniveauer. Dette står under "Output" i \tableref{Tab:faktor18_test}.\
\begin{table}[H]
	\centering
	\begin{tabular}{|l|l|l|l|l|}
		\hline
...
Der ses ud fra testen, at forstærkeren overholder kravene fra afsnit \ref{OpsamlingsAfs} på side \pageref{OpsamlingsAfs}, samt ligger inde for afvigelser i forstærkningen, som er $\pm2\%$, da forstærkeren har en maksimal afvigelse på $0.66\%$. Derfor anses disse afvigelser som acceptable.