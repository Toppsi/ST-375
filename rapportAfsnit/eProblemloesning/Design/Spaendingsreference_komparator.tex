...
Der foretages en simulering i LTspice, for at undersøge, hvorvidt designet fungerer ideelt og præcisionen af spændingsreferencen. Simuleringens resultatet fremgår af \tableref{Tab:SpaendigsRef_komparator}
...
\end{table}
\noindent I \tableref{Tab:SpaendigsRef_komparator} fremgår det, at der er en lav afvigelse mellem det forventede output og det simulerede output, hvorfor referencespændingen til feedbackkonfigurationen accepteres ift. kravspecifikationerne. En lav afvigelse mellem de teoretiske værdier og simuleringen forventes, da der benyttes ideelle komponenter i LTspice. Derved fungerer kredsløbet teoretisk og kan implementeres. På \figref{fig:Spaendingsreference_komparator_sim} ses simuleringen af spændingsreferencen og operationsforstærkeren.
\begin{figure}[H]
	\centering
