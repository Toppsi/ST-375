...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		$R1_{eq}$: & $63661.9772\Omega$ & $63633\Omega$ &  $0.0455\%$ \\ \hline
		\multirow{2}{*}{\textit{$R_{2}$(Parallel) :}} & $680$K$\Omega$     & $682.840$K$\Omega$  & $0.4176\%$        \\ \cline{2-4} 
		& $47$K$\Omega$      & $47.004$K$\Omega$ & $0.01\%$           \\ \hline
		$R2_{eq}$: & $44115.2831\Omega$ & $43976\Omega$ & $0.3157\%$ \\ \hline
