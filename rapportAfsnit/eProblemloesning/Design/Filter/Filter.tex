...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		R$_{eq}$: & $63661.9772\Omega$ & $63633\Omega$ &  $0.0455%$ \\ \hline
		\multirow{2}{*}{\textit{$R_{2}$(Parallel) :}} & $680$K$\Omega$     & $682840\Omega$  & $0.4176\%$           \\ \cline{2-4} 
		& $47$K$\Omega$      & $47.004$K$\Omega$ & $0.01\%$           \\ \hline
		R$_{eq}$: & $44115.2831\Omega$ & $43976\Omega$ & $0.3157%$ \\ \hline
		\multirow{2}{*}{\textit{$R_{3}$(Parallel) :}} & $39$K$\Omega$      & $38.888\Omega$    & $0.3\%$           \\ \cline{2-4} 
		& $39$K$\Omega$     & $39043\Omega$        & $0.1\%$           \\ \hline
		R$_{eq}$: & $19546.694\Omega$ & $19482\Omega$  & $0.3310%$
	\end{tabular}
