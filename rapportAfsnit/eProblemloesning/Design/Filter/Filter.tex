...
\begin{figure}[H]
	...
	\caption{På figuren ses en illustration på et bodeplot, der viser 3. ordens filterets frekvensindhold målt i Hz over dæmpningen målt i dB. Lavpasfilteret er simuleret i LTspice.}
...
%\noindent Sammenlignes værdierne fra \ref{fig:Lavpas_Matlab} for det testede kredsløb med værdierne fra det simulerede kredsløb på \ref{fig:lavpasfilter_LTspice}, ses der en ændring i frekvens og dæmpning, hvilket er forventet, når der anvendes reelle kondensatorer og modstande.
...
\noindent Ud fra de testede værdier i \tableref{Tab:Tolerance} og kravspecifikationer i afsnit \ref{FilterAfs} på side \pageref{FilterAfs} ses ingen afvigelse på båndpas- og stopbåndsfrekvensen, men en variation i dæmpningen for både pasbånds- og stopbåndsfrekvensen på hhv. $8.8\%$ og $6.1$\% ift. kravspecikationerne.
