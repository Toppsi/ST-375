...
Ud fra de testede værdier i \ref{Tab:Tolerance} og kravspecifikationer \ref{filterAfs) er der er ingen afvigelse på knækfrekvensen og stopbåndsfrekvensen. Der er en ændring i forhold til dæmpningen for både stop- og pasbånd på hhv. $5.9\%$ og $12.65$ i forhold til kravet.
