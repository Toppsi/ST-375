...
\begin{subfigure}[a] {0.5}\textwidth}
	\includegraphics[width=\textwidth]{figures/cProblemloesning/Lavpasfilter_generisk.PNG}
\caption{Figuren viser et bodeplot for et 1. ordens filter, hvor de fire karakteristika af et lavpasfilter er angivet.}
\label{fig:lavpasfilter1_generisk}
\end{subfigure}
\begin{subfigure}[b] {0.5}\textwidth}
	\includegraphics[width=\textwidth]{figures/cProblemloesning/Lavpasfilter_generisk.PNG}
\caption{Figuren viser et bodeplot for et 2. orden filter, hvor de fire karakteristika af et lavpasfilter er angivet.}
...
\begin{figure}[H]
	...
	\caption{På figuren ses en illutration af et 3. ordens unity-gain Sallen-Key lavpasfilter} \fxnote{nyt billede}
	\label{fig:SallenKey}
\end{figure}

I designet af et 3. ordens filter designes både et første og et andens orden i forlængelse af hinanden. Et sallen-Key filteret består derfor af tre modstande og tre kondensatorer. Værdierne for modstandene kan udregnes med følgende ligninger:
