...
Sammenlignes grafen \ref{Lavpas_Matlab} for det testede kredsløb med grafen \ref{fig:lavpasfilter_LTspice} for det simulerede kredsløb ses der en ændring i frekvens og dæmpning. 
...
Dæmpning på pasbånd & $3dB$		& $2.663dB$	    & $12.65\%$ & \\ \hline
	\end{tabular}
	\caption{Afvigelse_filter}
	\label{Tab:Tolerance}
\end{table}

Ud fra de testede værdier i \ref{Tab:Tolerance} og kravspecifikationer \ref{filterAfs) er der er ingen afvigelse på knækfrekvensen og stopbåndsfrekvensen. Der er en ændring i forhold til dæmpningen for både stop- og pasbånd på hhv. $5.9\%$ og $12.65$ i forhold til kravet. I forhold til tolerance i afsnit \ref{filterAfs) skulle dæmpningen på stopbåndet være minimum $14 dB$ og have en afvigelse på $+10\%$. Denne tolerance overholdes da det maksimale for dæmpningen af stopbåndet er $15.4dB$. For pasbåndet skulle dæmpningen maksimalt være $3dB$ og have en afvigelse på $-15\%$. Dette vil sige at testen passer inden for tolerance, da pasbåndet minimalt må være $2.55dB$. På baggrund af dette accepteres afvigelserne for testen.