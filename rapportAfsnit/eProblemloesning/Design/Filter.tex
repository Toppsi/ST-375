...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.63]{figures/cProblemloesning/type_filtre.PNG}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.85]{figures/cProblemloesning/Lavpasfilter_generisk.PNG}
	\caption{Figuren viser et bodeplot filter, hvor de fire karakteristika af et lavpasfilter er angivet}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.32]{figures/cProblemloesning/Lavpasfiltergraf_LTspice1.PNG}
