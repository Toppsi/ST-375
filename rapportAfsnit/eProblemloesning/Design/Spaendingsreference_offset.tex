...
R$2$ i \eqref{eq:Spaendingsdeler} bliver valgt til at være $10$K$\Omega$. Derudover er $V_{out}$ $1.6325$V, $V_{in}$ er $2.5$V. Ligningen kommer til at se således ud: 
\begin{eqnarray}
...
Der foretages en simulering i LTspice af spændingsreferencen og spændingsdeleren for at undersøge, om opstillede krav opfyldes. Resultatet af simuleringen kan ses i \tableref{Tab:SpaendigsRef_offset}:
\begin{table}[H]
\centering
