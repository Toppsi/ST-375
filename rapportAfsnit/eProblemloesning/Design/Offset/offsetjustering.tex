...
\end{table}
\noindent Herefter implementeres kredsløbet. Til afbildning af signalet for de tre spændingsniveauer benyttes et oscilloskop, hvilket står under "Output" i \tableref{Tab:Offset_test}.
\begin{table}[H]
	\centering
