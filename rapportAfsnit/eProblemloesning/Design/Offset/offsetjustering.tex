...
\begin{table}[H]
	...
	\begin{tabular}{l|l|l|l|l|l|}
		...
		\multicolumn{1}{|l|}{\multirow{3}{*}{\textit{\begin{tabular}[c]{@{}l@{}}$V2$\\ signal\end{tabular}}}} & $1.8627$V   & $1.8619$V    & $0.2700$V   & $0.2689$V   & $0.41\%$     \\ \cline{2-7} 
...
\end{table}\fxnote{Det forventede output er regnet således, at den inpu det er udregnet udfra hvad i reelt har af input og reference, derefter tjekker vi om det vi målte passer med det vi fik ud}
