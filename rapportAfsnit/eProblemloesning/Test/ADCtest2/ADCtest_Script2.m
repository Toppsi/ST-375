...
axis([0 0.1 -3.5 3.5])
title('Måling 1: 100Hz frekvens, 3.0148V')
...
axis([0 0.1 -3.5 3.5])
title('Måling 2: 100Hz frekvens, -2.9420V')
xlabel('Tid i sekunder')
ylabel('Spænding målt i Volt')
...
axis([0 0.1 -5 5])
title('Måling 3: 25Hz frekvens, 4V')
xlabel('Tid i sekunder')
ylabel('Spænding målt i Volt')
...
axis([0 0.1 -3.5 3.5])
title('Måling 4: 25Hz frekvens, 3.0148V')
xlabel('Tid i sekunder')
ylabel('Spænding målt i Volt')
...
axis([0 0.1 -3.5 3.5])
title('Måling 5: 25Hz frekvens, -2.9420V')
xlabel('Tid i sekunder')
ylabel('Spænding målt i Volt')
