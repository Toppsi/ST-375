...
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Komparator}\label{KomparatorAfs} \fxnote{det at vi har et range på 180 grader gør, at vi skal regulere meget fint i tærskelværdierne. Kan dette påvirke designet af systemet?}
...
\item Skal have syv tærskelværdier, da der skal en til hver LED-diode og vibrator.
\end{itemize}
\textbf{Tolerance:}
\begin{itemize}
